...
from config import SAMPLING_RATE, EPOCH_LENGTH, EPOCH_OVERLAP, NOTCH_FREQ, ALL_CHANNELS, TARGET_CHANNELS, BASE_DIR
...
def preprocess_EEG(eeg_raw, freq_filter=True, notch_filter=False, asr=False, asr_cutoff=10, run_ica=False, referencing=False, AR=True, erp=False, fle=True):
